...
export const subjectApi = {
  ...
  getSemesterCompletionPreview: (id) => axiosClient.get(`/subjects/semesters/${id}/completion-preview`),
  completeSemester: (id, data) => axiosClient.post(`/subjects/semesters/${id}/complete`, data),
  reopenSemester: (id, data) => axiosClient.post(`/subjects/semesters/${id}/reopen`, data),
