...
namespace EHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260922102518_AddProposalComparativeAnalysisEvidence")]
    partial class AddProposalComparativeAnalysisEvidence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EHub.Domain.Entities.ProjectProposalAnalysisJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("CandidateScope")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("candidate_scope");
                    ...
                    b.Property<bool>("IncludeCrossSemester")
                        .HasColumnType("boolean")
                        .HasColumnName("include_cross_semester");

                    b.Property<string>("LanguageMode")
                        .IsRequired()
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("language_mode");
                    ...
                    b.ToTable("project_proposal_analysis_jobs", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProjectProposalAnalysisJob_AttemptCount", "attempt_count >= 0");
                        });
                });

            modelBuilder.Entity("EHub.Domain.Entities.ProjectProposalAnalysisMatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("CandidateProposalVersionId")
                        .HasColumnType("uuid")
                        .HasColumnName("candidate_proposal_version_id");
                    ...
                    b.Property<double>("HybridSimilarity")
                        .HasColumnType("double precision")
                        .HasColumnName("hybrid_similarity");

                    b.Property<double>("JaccardSimilarity")
                        .HasColumnType("double precision")
                        .HasColumnName("jaccard_similarity");

                    b.Property<string>("NovelElementsJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("novel_elements_json");

                    b.Property<double>("ProblemSimilarity")
                        .HasColumnType("double precision")
                        .HasColumnName("problem_similarity");
                    ...
                    b.Property<string>("SimilaritiesJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("similarities_json");

                    b.Property<double>("SolutionSimilarity")
                        .HasColumnType("double precision")
                        .HasColumnName("solution_similarity");

                    b.Property<double>("TargetCustomerSimilarity")
                        .HasColumnType("double precision")
                        .HasColumnName("target_customer_similarity");

                    b.Property<double>("TfIdfSimilarity")
                        .HasColumnType("double precision")
                        .HasColumnName("tf_idf_similarity");

                    b.Property<double>("ValueAndApproachSimilarity")
                        .HasColumnType("double precision")
                        .HasColumnName("value_and_approach_similarity");

                    b.Property<double>("WeightedSemanticSimilarity")
                        .HasColumnType("double precision")
                        .HasColumnName("weighted_semantic_similarity");

                    b.HasKey("Id");

                    b.HasIndex("CandidateProposalVersionId");

                    b.HasIndex("AnalysisResultId", "CandidateProposalVersionId")
                        .IsUnique();

                    b.HasIndex("AnalysisResultId", "Rank")
                        .IsUnique();

                    b.ToTable("project_proposal_analysis_matches", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProjectProposalAnalysisMatch_FieldScores", "problem_similarity >= -1 AND problem_similarity <= 1 AND solution_similarity >= -1 AND solution_similarity <= 1 AND target_customer_similarity >= -1 AND target_customer_similarity <= 1 AND value_and_approach_similarity >= -1 AND value_and_approach_similarity <= 1 AND weighted_semantic_similarity >= -1 AND weighted_semantic_similarity <= 1");

                            t.HasCheckConstraint("CK_ProjectProposalAnalysisMatch_HybridScore", "hybrid_similarity >= -1 AND hybrid_similarity <= 1");

                            t.HasCheckConstraint("CK_ProjectProposalAnalysisMatch_LexicalScores", "tf_idf_similarity >= 0 AND tf_idf_similarity <= 1 AND jaccard_similarity >= 0 AND jaccard_similarity <= 1");

                            t.HasCheckConstraint("CK_ProjectProposalAnalysisMatch_Rank", "rank > 0");

                            t.HasCheckConstraint("CK_ProjectProposalAnalysisMatch_Similarity", "semantic_similarity >= -1 AND semantic_similarity <= 1");
                        });
                });

            modelBuilder.Entity("EHub.Domain.Entities.ProjectProposalAnalysisResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("FieldScoringVersion")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("field_scoring_version");

                    b.Property<string>("FieldTextSchemaVersion")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("field_text_schema_version");

                    b.Property<string>("FieldWeightsJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("field_weights_json");

                    b.Property<DateTime>("GeneratedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("generated_at_utc");

                    b.Property<string>("HybridScoringVersion")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("hybrid_scoring_version");

                    b.Property<string>("HybridWeightsJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("hybrid_weights_json");

                    b.Property<string>("LexicalScoringVersion")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("lexical_scoring_version");
                    ...
                    b.Property<string>("OverlapRisk")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("overlap_risk");

                    b.Property<string>("PotentialDifferentiatorsJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("potential_differentiators_json");
                    ...
                    b.Property<string>("RetrievalVersion")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("retrieval_version");
                    ...
                    b.Property<string>("TextSchemaVersion")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("text_schema_version");
                    ...
                    b.ToTable("project_proposal_analysis_results", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProjectProposalAnalysisResult_RetrievalCandidateCount", "retrieval_candidate_count >= 0 AND retrieval_candidate_count <= 10");
                        });
                });

            modelBuilder.Entity("EHub.Domain.Entities.ProjectProposalEmbedding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ContentHash", "TextSchemaVersion", "Provider", "Model", "Dimension");

                    b.ToTable("project_proposal_embeddings", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProjectProposalEmbedding_Dimension", "dimension > 0 AND dimension <= 3072");
                        });
                });

            modelBuilder.Entity("EHub.Domain.Entities.ProjectProposalFieldEmbedding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ProposalVersionId", "Field")
                        .IsUnique();

                    b.HasIndex("ContentHash", "TextSchemaVersion", "Provider", "Model", "Dimension");

                    b.ToTable("project_proposal_field_embeddings", null, t =>
                        {
                            t.HasCheckConstraint("CK_ProjectProposalFieldEmbedding_Dimension", "dimension > 0 AND dimension <= 3072");
                        });
                });

            modelBuilder.Entity("EHub.Domain.Entities.ProjectProposalReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ProjectProposalId", "OccurredAtUtc");

                    b.ToTable("project_proposal_reviews", (string)null);
                });
            ...
            modelBuilder.Entity("EHub.Domain.Entities.ProjectProposalAnalysisJob", b =>
                {
                    b.HasOne("EHub.Domain.Entities.ProjectProposalVersion", "ProposalVersion")
                        .WithOne("AnalysisJob")
                        .HasForeignKey("EHub.Domain.Entities.ProjectProposalAnalysisJob", "ProposalVersionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EHub.Domain.Entities.User", "RequestedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("EHub.Domain.Entities.ProjectProposalAnalysisMatch", b =>
                {
                    b.HasOne("EHub.Domain.Entities.ProjectProposalAnalysisResult", "AnalysisResult")
                        .WithMany("Matches")
                        .HasForeignKey("AnalysisResultId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EHub.Domain.Entities.ProjectProposalVersion", "CandidateProposalVersion")
                        .WithMany()
                        .HasForeignKey("CandidateProposalVersionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("AnalysisResult");

                    b.Navigation("CandidateProposalVersion");
                });

            modelBuilder.Entity("EHub.Domain.Entities.ProjectProposalAnalysisResult", b =>
                {
                    b.HasOne("EHub.Domain.Entities.ProjectProposalAnalysisJob", "AnalysisJob")
                        .WithOne("Result")
                        .HasForeignKey("EHub.Domain.Entities.ProjectProposalAnalysisResult", "AnalysisJobId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("EHub.Domain.Entities.ProjectProposalEmbedding", b =>
                {
                    b.HasOne("EHub.Domain.Entities.ProjectProposalVersion", "ProposalVersion")
                        .WithOne("Embedding")
                        .HasForeignKey("EHub.Domain.Entities.ProjectProposalEmbedding", "ProposalVersionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
